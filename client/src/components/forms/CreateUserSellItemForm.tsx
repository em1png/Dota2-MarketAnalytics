...
import { RootState, fetchItemType } from "@/types/types"
...
const CreateUserSellItem = ({ reqType, item, title, className }: { title: string | ReactNode, reqType: 'POST' | 'PUT', item: fetchItemType, className: string }) => {
